...
slave_host="10.0.13.245 10.0.18.12 10.0.18.70 10.0.18.71 10.0.19.216 10.0.19.217 10.0.19.218"
...
} || rollback "execute php scripts error: $? `cat /dev/shm/search_index_full.log`"
